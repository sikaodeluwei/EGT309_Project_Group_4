...
It handles target text-uniformity processing to collapse formatting typos dynamically.
"""
...
# =========================================================================
# CRITICAL PATH REGISTER: This MUST be at the very top of the file
# =========================================================================
...
# FIXED IMPORT: Points directly to src.config where Zhenyu moved it
...
class BasicModelTrainer:
    """
    Trains and compares multiple baseline classification models using configurations
    from config.py and performing target string uniforming steps.
    """
